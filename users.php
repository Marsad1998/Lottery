...
<!-- start page content -->
	...
	<?php
			      ...
			      <label for="clientContact" class="col-sm-2 control-label">Branch </label>
			    ...
			    <div class="col-sm-4">
			        <select class="form-control" name="branch_id">
			    	  	...
			    	  	?>
			     	<option value="<?=@$fetchusers['branch_id']?>"><?=@$fetchusers['branch_name']?></option>
			     	<?php
			     
			     		$fetchbranch= mysqli_query($dbc,"SELECT * FROM branches WHERE branch_sts = 1");
			     		while($branch = mysqli_fetch_assoc($fetchbranch)):?>
