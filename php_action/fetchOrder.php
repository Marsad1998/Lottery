 ...
 while($row = $result->fetch_array()) {
	...
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu">
	    <li><a href="orders.php?o=editOrd&i='.$orderId.'" id="editOrderModalBtn"> <i class="fa fa-edit"></i> Edit</a></li>
	    <li><a href="print_order_profit.php?i='.$orderId.'" id="editOrderModalBtn"> <i class="fa fa-check"></i> Print Order Profit</a></li>
	    ...
	    <li><a type="button" data-toggle="modal" data-target="#removeOrderModal" id="removeOrderModalBtn" onclick="removeOrder('.$orderId.')"> <i class="fa fa-trash"></i> Remove</a></li>       
	  </ul>
	</div>';
	$client_name = $row[2];		
