    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class="pull-left">
                    <div class="page-title">Balance Sheet<a href="#modal-1" class="btn btn-sm btn-primary ml-5" data-toggle="modal" href='#modal-id'><i class="fa fa-pencil"></i> Add New</a></div>
                </div>
		...
		<div class="panel">
			<div class="panel-heading text-white cyan-bgcolor"><h4>Balance Sheet</h4></div>
				<div class="panel-body">
                    ...
                    <div class="row">
                        <div class="offset-8 col-sm-4">
                            <div class="reportrange" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; width: 100%"><input type="hidden" class="page_decide" value="balance">
                    ...
                    <hr>
					<table class="table" id="balance_sheets">
						<thead>
							<tr>	
								<th>ID</th>
								<th>Last Name</th>
