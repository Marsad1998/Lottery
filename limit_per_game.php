    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class="pull-left">
                    <div class="page-title">Limit Management per Game<a href="#modal-1" class="btn btn-sm btn-primary ml-5" data-toggle="modal" href='#modal-id'><i class="fa fa-pencil"></i> Add New</a></div>
                </div>
		...
		<div class="panel">
			<div class="panel-heading text-white cyan-bgcolor"><h4>List of Limitation</h4></div>
				<div class="panel-body">
							...
							<div class="col-sm-3">
								<div class="form-group">
									<div class="row">
										...
										<div class="col-sm-9">
											<select style="width: 100%" name="lottery_for_search" id="lottery_for_search" class="form-control-sm limit_per_game" required="required">
												<option value=""></option>
								...
								<div class="form-group">
									<div class="row">
										...
										<div class="col-sm-9">
											<select style="width: 100%" name="seller_id" id="seller_id" class="form-control-sm limit_per_game" required="required">
												<option value=""></option>
							...
							<div class="col-sm-4">
								<div class="form-group">
									<div class="row">
										...
										<div class="col-sm-8">
											<select style="width: 100%" name="game_type" id="game_type" class="form-control-sm limit_per_game" required="required">
												<option value=""></option>
					...
					<table class="table" id="limit_per_game">
						<thead>
							<tr>	
								<th>ID</th>
								<th>Lottery</th>
