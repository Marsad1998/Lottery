 <div class="chat-sidebar-container" data-close-on-body-click="false">
        ...
        <div class="page-footer">
            <!-- <div class="page-footer-inner"> <?=date('Y')?> &copy; Spice Hotel Template By
   ...
   <!--  <script src="custom/js/purchase.js" ></script> -->
    ...
    <script src="custom/js/todo.js" ></script>
    ...
    <!-- <script src="assets/plugins/datatables/plugins/bootstrap/dt1.js" ></script> -->
    <!-- <script src="assets/plugins/datatables/plugins/bootstrap/dt2.js" ></script> -->
    <!-- <script src="assets/plugins/datatables/plugins/bootstrap/dt3.js" ></script> -->
    <!-- <script src="assets/plugins/datatables/plugins/bootstrap/dt4.js" ></script> -->
    <!-- <script src="assets/plugins/datatables/plugins/bootstrap/dt5.js" ></script> -->
    <!-- <script src="assets/plugins/datatables/plugins/bootstrap/dt6.js" ></script> -->
    <!-- <script src="assets/plugins/datatables/plugins/bootstrap/dt7.js" ></script> -->
