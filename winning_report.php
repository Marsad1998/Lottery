    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class="pull-left">
                    <div class="page-title">Sale Report<a href="#modal-1" class="btn btn-sm btn-primary ml-5" data-toggle="modal" href='#modal-id'><i class="fa fa-pencil"></i> Add New</a></div>
                </div>
		...
		<div class="panel">
			<div class="panel-heading text-white cyan-bgcolor"><h4>Sale Report</h4></div>
				<div class="panel-body">
                    ...
                    <hr>
					<table class="table" id="sale_report">
						<thead>
							<tr>	
								<th>ID</th>
								<th>Seller</th>
