				...
				<div class="panel-body">
							...
							<div class="col-sm-4">
								<div class="form-group">
									<div class="row">
										...
										<div class="col-sm-8">
											<select style="width: 100%" name="draw" id="draw" class="form-control-sm limit_per_ball" required="required">
												<option value=""></option>
                    ...
                    <div class="row">
                        <div class="offset-8 col-sm-4">
                            <div class="reportrange" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; width: 100%"><input type="hidden" class="page_decide" value="overview">
                    ...
                    <hr>
					<table class="table" id="overview_of_limits">
						<thead>
							<tr>	
								<th>ID</th>
								<th>Date</th>
